...
const dark = {
  ...
  textLight: 'color-mix(in lab, var(--text) 70%, transparent)',
};
...
const light = {
  ...
  textBody: 'color-mix(in lab, var(--text) 100%, transparent)',
  textLight: 'color-mix(in lab, var(--text) 80%, transparent)',
};
